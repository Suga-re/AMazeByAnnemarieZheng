...
public class StatePlaying implements State {
     ...
     * @param playManual a PlayManuallyActivity obj
     */
...
//
//        	addSensor(Direction.BACKWARD,control.back);
//        	startThread(control.back);
//
//        	addSensor(Direction.LEFT,control.left);
//        	startThread(control.left);
//
//    		addSensor(Direction.RIGHT,control.right);
//    		startThread(control.right);
//
//
//            control.robot.setController(control);
//
//            control.driver.setMaze(maze);
////            controller.robot.setBatteryLevel(50);
//
//
//            try {
//            	control.robot.setBatteryLevel(3500);
//            	control.currentState.handleUserInput(UserInput.TOGGLEFULLMAP, 10);
//            	control.currentState.handleUserInput(UserInput.TOGGLESOLUTION, 10);
//            	control.currentState.handleUserInput(UserInput.TOGGLELOCALMAP, 10);
//    			control.driver.drive2Exit();
//    			if (control.driver.drive2Exit()==true) {
//					controller.robot.move(1); //drives the robot out of maze
//				}
//    			else {//robot has a failure so end round of game
//    				((StatePlaying) control.currentState).switchFromPlayingToWinning(control.driver.getPathLength());
//    			}
//    		} catch (Exception e) {
//    			((StatePlaying) control.currentState).switchFromPlayingToWinning(control.driver.getPathLength());
//    		}
...
//    protected void startThread(DistanceSensor sensor) {
//    	if (sensor instanceof UnreliableSensor) {
//			sensor.startFailureAndRepairProcess(0, 0);
//			try {
//				Thread.sleep(1300); //delay by 1.3 seconds between unreliable Sensor start
//			} catch (InterruptedException e) {
//			}
//		}
//
//	}
//    protected void endThread(DistanceSensor sensor) {
//    	if (sensor instanceof UnreliableSensor) {
//			sensor.stopFailureAndRepairProcess();
//		}
//
//	}
//    private void addSensor(Direction direction,DistanceSensor sensor) {
//
//    	sensor.setMaze(maze);
//    	switch (direction) {
//		case FORWARD: {
//    		sensor.setSensorDirection(Direction.FORWARD);
//    		control.robot.addDistanceSensor(sensor, Direction.FORWARD);
//    		break;
//		}
//		case BACKWARD:{
...
//    		control.robot.addDistanceSensor(sensor, Direction.RIGHT);
//    		break;
//		}
//    	}
//    }
...
//                switchFromPlayingToWinning(0);
            ...
            System.out.printf("current location is: (%d, %d)\n",px, py);
            System.out.printf("current direction is:%s",cd);
            break;
        case LEFT: // turn left
