...
//        }
	 ...
	 * @param panel the graphics panel to manipulate screen
	...
	private void drawMap(MazePanel panel, int px, int py, int walkStep,
		...
		panel.setColor(panel.getColor(MazePanel.MazeColors.MAP_DEFAULT));
	 ...
	 * @param panel the graphics panel to draw on
	...
	private void drawCurrentLocation(MazePanel panel, int viewDX, int viewDY) {
		panel.setColor(panel.getColor(MazePanel.MazeColors.MAP_CURRENTLOCATION));
	...
	private void drawSolution(MazePanel panel, int offsetX, int offsetY, int px, int py) {
		...
		panel.setColor(panel.getColor(MazePanel.MazeColors.MAP_SOLUTION));
